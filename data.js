(() => {
  ...
  const tracks = [
    ...
    {id:'nurburgring', name:'Nürburgring', country:'Германия', length:5.148, configs:['Grand Prix','Sprint','Nordschleife'], games:['ac','acc','iracing','f1','ace'], type:'road', difficulty:4, corners:15, path:'M20 75 C14 61,27 47,22 33 C18 21,32 13,45 19 C55 24,63 10,77 15 C91 20,94 38,82 47 C70 55,88 68,78 82 C66 99,47 83,35 92 C25 98,22 87,20 75 Z'},
    {id:'silverstone', name:'Silverstone', country:'Великобритания', length:5.891, configs:['Grand Prix','International'], games:['ac','acc','iracing','f1','ace'], type:'road', difficulty:4, corners:18, path:'M14 68 L24 43 L39 39 L41 18 L62 24 L72 14 L91 32 L79 47 L93 63 L74 80 L56 73 L43 93 L28 81 Z'},
    {id:'suzuka', name:'Suzuka', country:'Япония', length:5.807, configs:['Grand Prix','East'], games:['ac','iracing','f1'], type:'road', difficulty:5, corners:18, path:'M19 33 C33 11,58 14,60 34 C61 48,42 50,35 61 C28 72,41 92,57 86 C74 80,68 62,81 54 C94 47,96 70,82 77 C68 85,61 65,50 64 C38 63,32 49,19 53 C7 56,8 42,19 33 Z'},
    {id:'imola', name:'Imola', country:'Италия', length:4.909, configs:['Grand Prix'], games:['ac','acc','iracing','f1','ace'], type:'road', difficulty:4, corners:19, path:'M18 77 C7 61,18 47,31 43 L42 19 C47 8,63 12,66 25 L70 42 C74 51,90 47,93 61 C96 75,82 86,69 80 L53 72 C43 67,35 88,18 77 Z'},
    {id:'redbullring', name:'Red Bull Ring', country:'Австрия', length:4.318, configs:['Grand Prix'], games:['ac','acc','iracing','f1','ace'], type:'road', difficulty:3, corners:10, path:'M16 76 C26 60,37 49,49 35 L68 14 C74 7,86 13,82 24 L72 49 C68 59,87 65,83 78 C79 91,59 93,48 84 C39 77,26 92,16 76 Z'},
    ...
    {id:'laguna', name:'Laguna Seca', country:'США', length:3.602, configs:['Full Course'], games:['ac','iracing'], type:'road', difficulty:4, corners:11, path:'M16 57 C13 40,26 27,43 30 C53 32,57 12,72 16 C85 20,82 39,72 45 C60 53,91 61,84 78 C76 96,53 82,39 88 C23 95,10 79,16 57 Z'},
    {id:'watkins', name:'Watkins Glen', country:'США', length:5.472, configs:['Boot','Classic'], games:['ac','iracing'], type:'road', difficulty:4, corners:11, path:'M24 88 C14 76,19 61,31 55 C42 50,32 32,43 20 C54 9,72 15,74 31 C75 44,91 48,86 63 C81 78,65 71,57 84 C48 99,34 99,24 88 Z'},
    {id:'daytona', name:'Daytona', country:'США', length:5.729, configs:['Road Course','Oval'], games:['ac','iracing'], type:'mixed', difficulty:3, corners:12, path:'M16 51 C17 25,38 12,61 17 C84 22,95 43,88 66 C82 87,59 96,38 87 C17 78,8 65,16 51 Z M39 45 C49 34,65 37,70 49 C74 61,62 70,50 65 C39 61,32 53,39 45 Z'},
    ...
    {id:'paulricard', name:'Paul Ricard', country:'Франция', length:5.842, configs:['1A-V2','GT'], games:['ac','acc'], type:'road', difficulty:3, corners:15, path:'M14 54 L35 16 L55 19 L70 10 L92 27 L76 48 L90 69 L68 89 L49 76 L29 92 L17 72 Z'},
    ...
    {id:'barcelona', name:'Barcelona-Catalunya', country:'Испания', length:4.657, configs:['GP no chicane','Grand Prix'], games:['ac','acc','iracing','f1'], type:'road', difficulty:4, corners:14, path:'M16 67 C20 51,35 47,30 31 C25 16,45 10,57 19 C69 28,81 17,88 31 C94 44,81 53,73 60 C65 67,82 82,68 90 C54 98,42 80,31 84 C19 88,10 80,16 67 Z'},
    {id:'lemans', name:'Le Mans', country:'Франция', length:13.626, configs:['Circuit de la Sarthe'], games:['ac','iracing'], type:'road', difficulty:5, corners:38, path:'M16 76 L29 50 L23 26 L43 15 L56 31 L70 12 L86 21 L80 50 L93 68 L76 88 L56 78 L39 95 L28 79 Z'},
    {id:'drift', name:'Drift Playground', country:'Виртуальная', length:1.8, configs:['Open','Technical'], games:['ac','other'], type:'drift', difficulty:3, corners:14, path:'M15 53 C17 30,36 22,52 36 C65 48,75 22,88 35 C99 47,82 62,68 57 C52 51,57 82,38 84 C20 86,8 70,15 53 Z'}
  ];
