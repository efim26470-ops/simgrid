(() => {
  ...
  const guideZoneProfiles = {
    redbullring:[
      ['T1 · Niki Lauda','Тормози по прямой и целись в поздний апекс: разгон в гору важнее скорости входа.'],
      ['T3 · Remus','Сними скорость до поворота и не блокируй внутреннее колесо на подъёме.'],
      ['T4 · Schlossgold','Начинай торможение раньше из-за спуска и оставь машину собранной до апекса.'],
      ['T6–T7','Не торопись в первую дугу: подготовь широкий вход и ранний газ из T7.'],
      ['T9–T10','Собери две дуги одним ритмом и не выезжай за лимиты на последнем выходе.']
    ],
    watkins:[
      ['T1','Поздний апекс и раннее распрямление руля дают скорость на подъём.'],
      ['The Esses','Работай одним плавным движением руля и не режь первый апекс слишком глубоко.'],
      ['Bus Stop','Тормози строго прямо; первый поребрик используй только для подготовки второго.'],
      ['The Boot','Сохрани терпение в длинной дуге и открой газ после стабилизации задней оси.'],
      ['T11','Не атакуй вход: приоритет — полный газ на стартовую прямую.']
    ],
    paulricard:[
      ['Virage de l’Hôtel','Зафиксируй торможение по прямой и подготовь поздний второй апекс.'],
      ['Sainte-Baume','Снизь скорость заранее и распрями машину для разгона на Mistral.'],
      ['Mistral / Signes','В Signes важнее один спокойный поворот руля, чем лишняя скорость входа.'],
      ['Beausset','Держи постоянный радиус и не добавляй газ раньше, чем открылся выход.'],
      ['Virage du Pont','Поздний апекс и чистая тяга определяют всю финишную прямую.']
    ],
    hungaroring:[
      ['T1','Тормози по прямой и оставь запас, чтобы рано открыть газ на спуске.'],
      ['T2','Не проваливайся внутрь слишком рано: поздний апекс готовит подъём.'],
      ['T4','Смотри через вершину холма и используй короткий, спокойный сброс газа.'],
      ['T6–T7 · Шикана','Сними скорость до первого поребрика и не ломай ритм резкой перекладкой.'],
      ['T14','Терпеливый вход и раннее раскрытие руля важнее атаки апекса.']
    ],
    barcelona:[
      ['T1–T3','Собери T1–T2 без лишней атаки и оставь машину слева перед длинной T3.'],
      ['T4','Держи ровный радиус и добавляй газ только после середины дуги.'],
      ['T5','Тормози раньше на спуске и не допускай блокировки внутреннего колеса.'],
      ['T10','Поздний апекс нужен для чистого разгона через следующий правый поворот.'],
      ['T14','Распускай машину к выходу и выходи на полный газ без коррекций рулём.']
    ],
    sebring:[
      ['T1','Оставь запас на неровностях и ищи поздний апекс, а не максимальную скорость входа.'],
      ['T3–T5','Свяжи смены направления плавно и не атакуй первый внутренний поребрик.'],
      ['T7 · Hairpin','Тормози прямо, поверни один раз и контролируй пробуксовку на выходе.'],
      ['T16 · Le Mans','Приоритет — тяга на длинную прямую; жертвуй входом ради раннего газа.'],
      ['T17 · Sunset Bend','Стабилизируй машину на кочках и держи выбранную дугу до выхода.']
    ],
    roadatlanta:[
      ['T1','Сохрани скорость на подъёме, но не заезжай слишком глубоко на внутренний поребрик.'],
      ['T3–T5 · Esses','Смотри на два поворота вперёд и не исправляй каждую дугу отдельно.'],
      ['T7','Поздний апекс и ранний газ важнее позднего торможения.'],
      ['T10A–T10B','Тормози строго прямо и используй первый апекс для подготовки второго.'],
      ['T12','Один уверенный поворот руля и полный газ после открытия выхода.']
    ],
    misano:[
      ['T1–T2 · Variante del Parco','Сними скорость заранее и не зажимай второй апекс.'],
      ['T4 · Rio','Зафиксируй машину перед сменой направления и не атакуй высокий поребрик.'],
      ['T8 · Quercia','Поздний апекс позволит раньше открыть газ на короткой прямой.'],
      ['T10 · Tramonto','Тормози ровно и контролируй тягу на длинном выходе.'],
      ['Curvone / Carro','Сохраняй плавную дугу и готовь торможение ещё до последней быстрой секции.']
    ],
    donington:[
      ['Redgate','Не торопись к апексу: выход должен оставить машину справа для Craner Curves.'],
      ['Craner Curves','Работай взглядом и одним ритмом, без резких коррекций рулём.'],
      ['Old Hairpin','Снизь скорость до спуска и не наезжай глубоко на внутренний поребрик.'],
      ['McLeans / Coppice','Подготовь поздний апекс Coppice ради разгона на Starkey’s Straight.'],
      ['Melbourne / Goddards','Тормози по прямой и отдавай приоритет выходу из последней медленной зоны.']
    ],
    bahrain:[
      ['T1–T3','Тормози по прямой, не зажимай T2 и распрями машину для разгона из T3.'],
      ['T4','Выбери поздний апекс: широкий вход помогает раньше открыть газ.'],
      ['T8 / T10','На спуске тормози раньше и избегай блокировки переднего внутреннего колеса.'],
      ['T11–T12','Сохраняй плавный руль и не атакуй первый апекс в ущерб второй дуге.'],
      ['T14–T15','Терпеливый вход и ранний полный газ определяют скорость на главной прямой.']
    ],
    jeddah:[
      ['T1–T2','Тормози по прямой и не зажимай второй поворот ранним апексом.'],
      ['T4–T10','Смотри через несколько поворотов и сохраняй один плавный ритм.'],
      ['T13','Оставь запас у стены и добавляй газ только после стабилизации дуги.'],
      ['T22–T23','Сними скорость до смены направления и избегай второй коррекции рулём.'],
      ['T27','Поздний апекс позволяет раньше открыть газ на финишную прямую.']
    ],
    drift:[
      ['Инициация','Заранее выбери точку входа и начинай с малого угла.'],
      ['Первая перекладка','Переноси массу плавно, не компенсируй ошибку лишним газом.'],
      ['Средняя дуга','Удерживай постоянный угол короткими и спокойными коррекциями.'],
      ['Клиппинг-пойнт','Смотри на выход и попадай в точку без потери инерции.'],
      ['Финишный выход','Уменьшай угол постепенно и выпрямляй машину после завершения дуги.']
    ]
  };
  ...
  guides.forEach((g,guideIndex)=>{
    ...
    g.checklist=[
      'Три разминочных круга без атаки',
      'Один повторяемый ориентир торможения',
      'Пять чистых кругов по одной линии',
      'Без лишних коррекций рулём',
      'Сравнены лучший и средний круг'
    ];
    g.sectors=g.sectors.map((sector,index)=>{
      ...
      return {...sector,
        braking:sector.braking|| (index===0?'150–120 м':index===g.sectors.length-1?'120–80 м':`${Math.max(55,130-index*12)}–${Math.max(35,95-index*9)} м`),
        entrySpeed:sector.entrySpeed||`≈ ${entry} км/ч`,
        apex:sector.apex|| (index%3===0?'Поздний':index%3===1?'Нейтральный':'Двойной / прогрессивный'),
        throttle:sector.throttle|| (index%2===0?'После стабилизации руля':'Плавно с середины дуги'),
        curb:sector.curb|| (index%3===0?'Умеренно, без удара днищем':index%3===1?'Можно использовать на выходе':'Избегай высокого внутреннего'),
    ...
    g.primaryGoal=`Стабильно пройти «${first.name}» пять кругов подряд`;
    g.sessionPlan=t.type==='drift'?'5 минут разминки + 5 связок':'3 разминочных + 5 рабочих кругов';
    g.quiz=[
